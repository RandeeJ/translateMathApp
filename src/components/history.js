...
class CalculationHistory extends Component {
  ...
  saveCalculation(event) {
    ...
    axios
      .post("https://cp-tma-api.herokuapp.com//calculation", {
  ...
  getCalculations() {
    axios
      .get("https://cp-tma-api.herokuapp.com//calculations")
      .then((response) => {
        // handle success
        this.setState({
  ...
  handleDeleteClick(id){
    axios.delete(`https://cp-tma-api.herokuapp.com//calculation/${id}`)
    .then((response) => {
